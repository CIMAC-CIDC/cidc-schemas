...
@assay_data_generator
def cytof_s1609_gd2car() -> PrismTestData:
    upload_type = "cytof_s1609_gd2car"
    prismify_args = get_prismify_args(upload_type)
    prismify_patch = {
        "assays": {
            "cytof_s1609_gd2car": [
                {
                    ...
                    "instrument": "PresNixon123",
                    "source_fcs": [
                        {"upload_placeholder": "4918a014-0e63-4a36-a45a-c62d593s1609"},
                        {"upload_placeholder": "0bbd7520-18b9-4ec3-8344-49f02dcs1609"},
                    ],
                    "controls_fcs": [
                        {"upload_placeholder": "c918a014-0e63-4a36-a45a-c62d593s1609"},
                        {"upload_placeholder": "cbbd7520-18b9-4ec3-8344-49f02dcs1609"},
                    ],
                    "control_spike_in_fcs": [
                        {"upload_placeholder": "a918a014-0e63-4a36-a45a-c62d593s1609"},
                        {"upload_placeholder": "abbd7520-18b9-4ec3-8344-49f02dcs1609"},
                    ],
                    "batch_id": "XYZ1",
                    "injector": "HAT123",
                    "date_of_acquisition": "43355",
    ...
    upload_entries = [
        ...
        LocalFileUploadEntry(
            local_path="sample2.fcs",
            gs_key="test_prism_trial_id/cytof_s1609_gd2car/CTTTPP121.00/processed.fcs",
            upload_placeholder="7e992a16-9c6a-4ef1-90b8-ef1a599s1609",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            ...
            gs_key="test_prism_trial_id/cytof_s1609_gd2car/CTTTPP121.00/spike_in.fcs",
            upload_placeholder="6e992a16-9c6a-4ef1-90b8-ef1a599s1609",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="batch1f1.fcs",
            gs_key="test_prism_trial_id/cytof_s1609_gd2car/XYZ1/source_0.fcs",
            upload_placeholder="4918a014-0e63-4a36-a45a-c62d593s1609",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="batch1f2.fcs",
            gs_key="test_prism_trial_id/cytof_s1609_gd2car/XYZ1/source_1.fcs",
            upload_placeholder="0bbd7520-18b9-4ec3-8344-49f02dcs1609",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            ...
            gs_key="test_prism_trial_id/cytof_s1609_gd2car/XYZ1/control_0.fcs",
            upload_placeholder="c918a014-0e63-4a36-a45a-c62d593s1609",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            ...
            gs_key="test_prism_trial_id/cytof_s1609_gd2car/XYZ1/control_1.fcs",
            upload_placeholder="cbbd7520-18b9-4ec3-8344-49f02dcs1609",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="control1-vericell.fcs",
            gs_key="test_prism_trial_id/cytof_s1609_gd2car/XYZ1/control_0_spike_in.fcs",
            upload_placeholder="a918a014-0e63-4a36-a45a-c62d593s1609",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="control2-vericell.fcs",
            gs_key="test_prism_trial_id/cytof_s1609_gd2car/XYZ1/control_1_spike_in.fcs",
            upload_placeholder="abbd7520-18b9-4ec3-8344-49f02dcs1609",
            metadata_availability=False,
            allow_empty=False,
        ),
