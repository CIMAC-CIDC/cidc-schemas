                ...
                "samples": [
                    {
                        ...
                        "parent_sample_id": "encrypt('TTTPP1A1')",
                        "processed_sample_id": "encrypt('BIOBANK 1A1')",
                        "box_number": "1",
                        "sample_location": "A1",
                    ...
                    },
                    {
                        ...
                        "collection_event_name": "Baseline",
                        "parent_sample_id": "encrypt('TTTPP1A2')",
                        "processed_sample_id": "encrypt('BIOBANK 1A2')",
                    ...
                    },
                    {
                        ...
                        "collection_event_name": "Baseline",
                        "parent_sample_id": "encrypt('TTTPP1A3')",
                        "processed_sample_id": "encrypt('BIOBANK 1A3')",
                ...
                "samples": [
                    {
                        ...
                        "collection_event_name": "Baseline",
                        "parent_sample_id": "encrypt('TTTPP2A1')",
                    ...
                    },
                    {
                        ...
                        "collection_event_name": "Baseline",
                        "parent_sample_id": "encrypt('TTTPP2A3')",
                        "processed_sample_id": "encrypt('BIOBANK 2A3')",
        ...
        "participants": [
            {
                "samples": [
                    ...
                    },
                    {
                        ...
                        "collection_event_name": "Baseline",
                        "parent_sample_id": "encrypt('TRIALGROUP 2')",
                        "processed_sample_id": "encrypt('BIOBANK 2')",
                        "cimac_id": "CTTTP05T2.00",
                        "box_number": "1",
                        "sample_location": "A2",
                        "type_of_sample": "Skin Tissue",
                    ...
                    },
                    {
                        ...
                        "collection_event_name": "Baseline",
                        "parent_sample_id": "encrypt('TRIALGROUP 3')",
                        "processed_sample_id": "encrypt('BIOBANK 3')",
                        "cimac_id": "CTTTP05T3.00",
                        "box_number": "1",
                        "sample_location": "A3",
                        "type_of_sample": "Skin Tissue",
                ...
                "samples": [
                    {
                        ...
                        "collection_event_name": "Baseline",
                        "parent_sample_id": "encrypt('TRIALGROUP 4')",
                        "processed_sample_id": "encrypt('BIOBANK 4')",
                        "cimac_id": "CTTTP06T1.00",
                        "box_number": "1",
                        "sample_location": "A4",
                        "type_of_sample": "Skin Tissue",
                    ...
                    },
                    {
                        ...
                        "collection_event_name": "Baseline",
                        "parent_sample_id": "encrypt('TRIALGROUP 5')",
                        "processed_sample_id": "encrypt('BIOBANK 5')",
                        "cimac_id": "CTTTP06T2.00",
                        "box_number": "1",
                        "sample_location": "A5",
                        "type_of_sample": "Skin Tissue",
                    ...
                    },
                    {
                        ...
                        "collection_event_name": "Baseline",
                        "parent_sample_id": "encrypt('TRIALGROUP 6')",
                        "processed_sample_id": "encrypt('BIOBANK 6')",
                        "cimac_id": "CTTTP06T3.00",
                        "box_number": "1",
                        "sample_location": "A6",
                        "type_of_sample": "Skin Tissue",
        ...
        "participants": [
            {
                ...
                "arbitrary_trial_specific_clinical_annotations": {
                    ...
                    "cohort": "Lung",
                    "arm": "ARM C",
                    "ECOG_PS": "1",  # number stored as text in the template_example
                    "age": 52,
                    "Prior surgery": "Y",
                    "prior RT": "Y",
                    ...
                    "prog1=Y)ression (": 1,
                    "days to progression": 58,
                    "died (1=Y)": 1,
                    "overall survival": 102,
                },
            }
        ],
    }
