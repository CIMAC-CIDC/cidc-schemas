        ...
        [
            [
                ...
                LocalFileUploadEntry(
                    ...
                    gs_key=f"test_prism_trial_id/rna/quality/{cimac_id}/rseqc/downsampling_housekeeping.bam",
                ...
                LocalFileUploadEntry(
                    ...
                    gs_key=f"test_prism_trial_id/rna/quality/{cimac_id}/rseqc/downsampling_housekeeping.bam.bai",
                    upload_placeholder=f"20202020-2020-2020-2020-{cimac_id}",
                    metadata_availability=None,
                ),
                LocalFileUploadEntry(
                    local_path=f"analysis/rseqc/read_distrib/{cimac_id}/{cimac_id}.txt",
                    gs_key=f"test_prism_trial_id/rna/quality/{cimac_id}/rseqc/read_distrib.txt",
                    upload_placeholder=f"21212121-2121-2121-2121-{cimac_id}",
                    metadata_availability=None,
                ),
                LocalFileUploadEntry(
                    local_path=f"analysis/rseqc/tin_score/{cimac_id}/{cimac_id}.summary.txt",
                    gs_key=f"test_prism_trial_id/rna/quality/{cimac_id}/rseqc/tin_score.summary.txt",
                ...
                LocalFileUploadEntry(
                    ...
                    gs_key=f"test_prism_trial_id/rna/quality/{cimac_id}/rseqc/tin_score.txt",
                    upload_placeholder=f"23232323-2323-2323-2323-{cimac_id}",
                    metadata_availability=None,
                ),
                LocalFileUploadEntry(
                    local_path=f"analysis/salmon/{cimac_id}/{cimac_id}.quant.sf",
                    gs_key=f"test_prism_trial_id/rna/gene-quantification/{cimac_id}/salmon/quant.sf",
