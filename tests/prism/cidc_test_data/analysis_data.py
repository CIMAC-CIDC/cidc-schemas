...
def wes_analysis() -> PrismTestData:
    ...
    upload_entries = [
        ...
        LocalFileUploadEntry(
            local_path="analysis/somatic/run_1/run_1_tnscope.filter.exons.center_targets.vcf.gz",
        ...
        LocalFileUploadEntry(
            local_path="analysis/report/somatic_variants/06_tumor_mutational_burden.tsv",
        ...
        [
            [
                ...
                LocalFileUploadEntry(
                    ...
                    gs_key=f"test_prism_trial_id/rna/{cimac_id}/analysis/fusion/{cimac_id}.fusion_predictions.abridged_addSample.tsv",
