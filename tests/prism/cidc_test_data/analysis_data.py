...
from .assay_data import cytof_10021, cytof_e4412
...
def wes_analysis() -> PrismTestData:
    ...
    upload_entries = [
        ...
        LocalFileUploadEntry(
            local_path="gs://results/analysis/somatic/run_1/run_1_tnscope.filter.exons.center_targets.vcf.gz",
            gs_key="test_prism_trial_id/wes/run_1/analysis/tnscope_exons.vcf.gz",
            upload_placeholder="09bb7dd5-083e-468e-b5c7-3c8eb3e77a94",
            metadata_availability=False,
            allow_empty=False,
        ),
        ...
        LocalFileUploadEntry(
            local_path="gs://results/analysis/somatic/run_2/run_2_tnscope.filter.exons.center_targets.vcf.gz",
...
def wes_tumor_only_analysis() -> PrismTestData:
    ...
    upload_entries = [
        LocalFileUploadEntry(
            local_path="gs://results/analysis/clonality/run_1/run_1_pyclone.tsv",
            gs_key="test_prism_trial_id/wes_tumor_only/run_1/analysis/clonality_pyclone.tsv",
            upload_placeholder="cdef9e1e-8e04-46ed-a9e6-bb618188a6d6",
            metadata_availability=False,
            allow_empty=False,
        ),
        ...
        LocalFileUploadEntry(
            local_path="gs://results/analysis/somatic/run_1/run_1_tnscope.filter.exons.center_targets.vcf.gz",
            gs_key="test_prism_trial_id/wes_tumor_only/run_1/analysis/tnscope_exons.vcf.gz",
            upload_placeholder="09bb7dd5-083e-468e-b5c7-3c8eb3e77a94",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="gs://results/analysis/purity/run_1/run_1.optimalpurityvalue.txt",
            gs_key="test_prism_trial_id/wes_tumor_only/run_1/analysis/optimal_purity_value.txt",
            upload_placeholder="f0b85ef8-47cb-45b9-bb94-c961150786b9",
            metadata_availability=False,
            allow_empty=False,
        ),
        ...
        LocalFileUploadEntry(
            local_path="gs://results/analysis/report/somatic_variants/06_tumor_mutational_burden.tsv",
            gs_key="test_prism_trial_id/wes_tumor_only/run_1/analysis/tumor_mutational_burden.tsv",
            upload_placeholder="d47271fb-e2c7-5436-cafe-5cf84bc72bf5",
            metadata_availability=False,
            allow_empty=False,
        ),
        ...
        LocalFileUploadEntry(
            local_path="gs://results/analysis/clonality/run_2/run_2_pyclone.tsv",
            gs_key="test_prism_trial_id/wes_tumor_only/run_2/analysis/clonality_pyclone.tsv",
            upload_placeholder="a4cba177-0be5-4d7d-b635-4a60adaa9575",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="gs://results/analysis/clonality/run_2/run_2_table.tsv",
            gs_key="test_prism_trial_id/wes_tumor_only/run_2/analysis/clonality_table.tsv",
            upload_placeholder="aucba177-0be5-4d7d-b635-4a60adaa9575",
            metadata_availability=False,
            allow_empty=False,
        ),
        ...
        LocalFileUploadEntry(
            local_path="gs://results/analysis/somatic/run_2/run_2_tnscope.filter.exons.center_targets.vcf.gz",
            gs_key="test_prism_trial_id/wes_tumor_only/run_2/analysis/tnscope_exons.vcf.gz",
            upload_placeholder="ba9d4b22-5610-4cde-b7e1-31ebf856a4ab",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="gs://results/analysis/germline/run_2/run_2_vcfcompare.txt",
            gs_key="test_prism_trial_id/wes_tumor_only/run_2/analysis/vcf_compare.txt",
            upload_placeholder="ht899d73-7373-4041-85f9-6cc4324be813",
            metadata_availability=False,
            allow_empty=False,
        ),
        ...
        LocalFileUploadEntry(
            local_path="gs://results/analysis/report/somatic_variants/06_tumor_mutational_burden.tsv",
            gs_key="test_prism_trial_id/wes_tumor_only/run_2/analysis/tumor_mutational_burden.tsv",
            upload_placeholder="66824763-fb9f-58b4-c7c4-8175759933f5",
            metadata_availability=False,
            allow_empty=False,
        ),
...
@analysis_data_generator
def cytof_e4412_analysis() -> PrismTestData:
    upload_type = "cytof_e4412_analysis"
    prismify_args = get_prismify_args(upload_type)
    prismify_patch = {
        "assays": {
            "cytof_e4412": [
    ...
    upload_entries = [
        ...
        LocalFileUploadEntry(
            local_path="CTTTPP211.00/fcs.fcs",
            gs_key="test_prism_trial_id/cytof_analysis/test_prism_trial_id_run_1/XYZ1/CTTTPP211.00/source.fcs",
            upload_placeholder="26fb0ada-8860-4a3d-a278-6b04a36291b9",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="CTTTPP211.00/assignment.csv",
            gs_key="test_prism_trial_id/cytof_analysis/test_prism_trial_id_run_1/XYZ1/CTTTPP211.00/assignment.csv",
            upload_placeholder="662a59f1-361c-4cc1-8502-5155120b1ec2",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="CTTTPP211.00/comp.csv",
            gs_key="test_prism_trial_id/cytof_analysis/test_prism_trial_id_run_1/XYZ1/CTTTPP211.00/compartment.csv",
            upload_placeholder="dbcb4352-001a-45d4-bbaf-46f1832859f3",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="CTTTPP211.00/profiling.csv",
            gs_key="test_prism_trial_id/cytof_analysis/test_prism_trial_id_run_1/XYZ1/CTTTPP211.00/profiling.csv",
            upload_placeholder="cb714f63-2849-4916-9fe8-421331c08759",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="CTTTPP211.00/cca.csv",
            gs_key="test_prism_trial_id/cytof_analysis/test_prism_trial_id_run_1/XYZ1/CTTTPP211.00/cell_counts_assignment.csv",
            upload_placeholder="91cc578a-77f3-4898-84ab-e124f1cf000f",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="CTTTPP211.00/ccc.csv",
            gs_key="test_prism_trial_id/cytof_analysis/test_prism_trial_id_run_1/XYZ1/CTTTPP211.00/cell_counts_compartment.csv",
            upload_placeholder="46f88f77-07ec-46b9-9e9f-53532ae96efc",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="CTTTPP211.00/ccp.csv",
            gs_key="test_prism_trial_id/cytof_analysis/test_prism_trial_id_run_1/XYZ1/CTTTPP211.00/cell_counts_profiling.csv",
            upload_placeholder="97634d45-5796-4210-80f6-c7f08c8f1e1d",
            metadata_availability=False,
            allow_empty=False,
        ),
    ...
    cimac_ids.append(
        "CTTTPP121.00"
    )  # not in analysis, but is in assay so need to add explicitly
    assays = cytof_e4412().prismify_patch["assays"]
    base_trial = get_test_trial(cimac_ids, assays)
